...
# MAGIC
# MAGIC we set the secret in the advanced setting: fs.azure.account.key.formula12345.dfs.core.windows.net {{secrets/formula12345-scope/formula12345-account-key}}
